#ifndef	__LINUX_USBNET_CYUSB_H
#define	__LINUX_USBNET_CYUSB_H

//#define RX_SKB_COPY

#define CYUSB3610_PHY_ID			0x03
#define CY_MCAST_FILTER_SIZE		8
#define CY_MAX_MCAST			64
#define CY_EEPROM_LEN			0x86   // 2017/01/17, for ethtool debug
#define CY_RX_CHECKSUM			1
#define CY_TX_CHECKSUM			2

#define CY_BULKIN_24K			0x18;	/* 24k */

#define CY_ACCESS_MAC			0x01
#define CY_ACCESS_PHY			0x02
#define CY_ACCESS_WAKEUP		0x03
#define CY_ACCESS_EEPROM		0x04
#define CY_ACCESS_EFUSE			0x05
#define CY_RELOAD_EEPROM_EFUSE		0x06
#define CY_WRITE_EFUSE_EN		0x09
#define CY_WRITE_EFUSE_DIS		0x0A
#define CY_ACCESS_MFAB			0x10

#define PHYSICAL_LINK_STATUS		0x02
	#define	CY_USB_SS		0x04
	#define	CY_USB_HS		0x02
	#define	CY_USB_FS		0x01

#define GENERAL_STATUS			0x03
/* Check CYUSB3610 version. UA1:Bit2 = 0,  UA2:Bit2 = 1 */
	#define	CY_SECLD		0x04



#define CY_SROM_ADDR			0x07
#define CY_SROM_CMD			0x0a
...
#define CY_SROM_DATA_LOW		0x08
#define CY_SROM_DATA_HIGH		0x09

#define CY_RX_CTL			0x0b
	#define CY_RX_CTL_DROPCRCERR		0x0100 /* Drop CRC error packet */
	#define CY_RX_CTL_IPE			0x0200 /* Enable IP header in receive buffer aligned on 32-bit aligment */
	#define CY_RX_CTL_TXPADCRC		0x0400 /* checksum value in rx header 3 */
	#define CY_RX_CTL_START			0x0080 /* Ethernet MAC start */
	#define CY_RX_CTL_AP			0x0020 /* Accept physcial address from Multicast array */
	#define CY_RX_CTL_AM			0x0010 /* Accetp Brocadcast frames*/
	#define CY_RX_CTL_AB			0x0008 /* HW auto-added 8-bytes data when meet USB bulk in transfer boundary (1024/512/64)*/
	#define CY_RX_CTL_HA8B			0x0004
	#define CY_RX_CTL_AMALL			0x0002 /* Accetp all multicast frames */
	#define CY_RX_CTL_PRO			0x0001 /* Promiscuous Mode */
	#define CY_RX_CTL_STOP			0x0000 /* Stop MAC */

#define CY_NODE_ID			0x10
#define CY_MULTI_FILTER_ARRY		0x16

#define CY_MEDIUM_STATUS_MODE			0x22
	#define CY_MEDIUM_GIGAMODE	0x01
	#define CY_MEDIUM_FULL_DUPLEX	0x02
//	#define CY_MEDIUM_ALWAYS_ONE	0x04
	#define CY_MEDIUM_EN_125MHZ	0x08
	#define CY_MEDIUM_RXFLOW_CTRLEN	0x10
	#define CY_MEDIUM_TXFLOW_CTRLEN	0x20
	#define CY_MEDIUM_RECEIVE_EN	0x100
	#define CY_MEDIUM_PS		0x200
	#define CY_MEDIUM_JUMBO_EN	0x8040

#define CY_MONITOR_MODE			0x24
	#define CY_MONITOR_MODE_RWLC		0x02
	#define CY_MONITOR_MODE_RWMP		0x04
	#define CY_MONITOR_MODE_RWWF		0x08
	#define CY_MONITOR_MODE_RW_FLAG		0x10
	#define CY_MONITOR_MODE_PMEPOL		0x20
	#define CY_MONITOR_MODE_PMETYPE		0x40

#define CY_GPIO_CTRL			0x25
	#define CY_GPIO_CTRL_GPIO3EN		0x80
	#define CY_GPIO_CTRL_GPIO2EN		0x40
	#define CY_GPIO_CTRL_GPIO1EN		0x20

#define CY_PHYPWR_RSTCTL		0x26
	#define CY_PHYPWR_RSTCTL_BZ		0x0010
	#define CY_PHYPWR_RSTCTL_IPRL		0x0020
	#define CY_PHYPWR_RSTCTL_AUTODETACH	0x1000

#define CY_RX_BULKIN_QCTRL		0x2e
	#define CY_RX_BULKIN_QCTRL_TIME		0x01
	#define CY_RX_BULKIN_QCTRL_IFG		0x02
	#define CY_RX_BULKIN_QCTRL_SIZE		0x04

#define CY_RX_BULKIN_QTIMR_LOW		0x2f
#define CY_RX_BULKIN_QTIMR_HIGH			0x30
#define CY_RX_BULKIN_QSIZE			0x31
#define CY_RX_BULKIN_QIFG			0x32

#define CY_CLK_SELECT			0x33
	#define CY_CLK_SELECT_BCS		0x01
	#define CY_CLK_SELECT_ACS		0x02
	#define CY_CLK_SELECT_ACSREQ		0x10
	#define CY_CLK_SELECT_ULR		0x08

#define CY_RXCOE_CTL			0x34
	#define CY_RXCOE_IP			0x01
	#define CY_RXCOE_TCP			0x02
	#define CY_RXCOE_UDP			0x04
	#define CY_RXCOE_ICMP			0x08
	#define CY_RXCOE_IGMP			0x10
	#define CY_RXCOE_TCPV6			0x20
	#define CY_RXCOE_UDPV6			0x40
	#define CY_RXCOE_ICMV6			0x80

#if LINUX_VERSION_CODE > KERNEL_VERSION(2, 6, 22)
	#define CY_RXCOE_DEF_CSUM	(CY_RXCOE_IP	| CY_RXCOE_TCP  | \
					 CY_RXCOE_UDP	| CY_RXCOE_ICMV6 | \
...
#define CY_TXCOE_CTL			0x35
	#define CY_TXCOE_IP			0x01
	#define CY_TXCOE_TCP			0x02
	#define CY_TXCOE_UDP			0x04
	#define CY_TXCOE_ICMP			0x08
	#define CY_TXCOE_IGMP			0x10
	#define CY_TXCOE_TCPV6			0x20
	#define CY_TXCOE_UDPV6			0x40
	#define CY_TXCOE_ICMV6			0x80
#if LINUX_VERSION_CODE > KERNEL_VERSION(2, 6, 22)
	#define CY_TXCOE_DEF_CSUM	(CY_TXCOE_TCP   | CY_TXCOE_UDP | \
					 CY_TXCOE_TCPV6 | CY_TXCOE_UDPV6)
#else
	#define CY_TXCOE_DEF_CSUM	(CY_TXCOE_TCP	| CY_TXCOE_UDP)
#endif

#define CY_PAUSE_WATERLVL_HIGH		0x54
#define CY_PAUSE_WATERLVL_LOW		0x55


#define CY_EEP_EFUSE_CORRECT		0x00
#define CYUSB3610_EEPROM_MAGIC			0x17900b95
...
#define OEM_AUTONEG_DISABLE (1 << 0)
#define OEM_AUTONEG_ENABLE  (1 << 1)
#define OEM_DUPLEX_HALF     (1 << 4)
#define OEM_DUPLEX_FULL     (1 << 5)
#define OEM_10Mbit          (1 << 8)
#define OEM_100Mbit         (1 << 9)
#define OEM_1000Mbit        (1 << 10)
/* 2017/11/30, export duplex control sysfs interface }*/
/******************************************************************************/

struct cyusb3610_data {
	u16 rxctl;
	u8  checksum;
} __attribute__ ((packed));

struct cyusb3610_async_handle {
  	struct usb_ctrlrequest *req;
  	u8 m_filter[8];
  	u16 rxctl;
} __attribute__ ((packed));

struct cyusb3610_int_data {
	__le16 res1;
#define CY_INT_PPLS_LINK	(1 << 0)
#define CY_INT_SPLS_LINK	(1 << 1)
#define CY_INT_CABOFF_UNPLUG	(1 << 7)
	u8 link;
	__le16 res2;
	u8 status;
	__le16 res3;
...
#define CY_RXHDR_L4_ERR		(1 << 8)
#define CY_RXHDR_L3_ERR		(1 << 9)


#define CY_RXHDR_L4_TYPE_ICMP		2
#define CY_RXHDR_L4_TYPE_IGMP		3
#define CY_RXHDR_L4_TYPE_TCMPV6		5

#define CY_RXHDR_L3_TYPE_IP		1
#define CY_RXHDR_L3_TYPE_IPV6		2

#define CY_RXHDR_L4_TYPE_MASK			0x1c
#define CY_RXHDR_L4_TYPE_UDP			4
#define CY_RXHDR_L4_TYPE_TCP			16
#define CY_RXHDR_L3CSUM_ERR			2
#define CY_RXHDR_L4CSUM_ERR			1
#define CY_RXHDR_CRC_ERR			0x20000000
#define CY_RXHDR_MII_ERR			0x40000000
#define CY_RXHDR_DROP_ERR			0x80000000
#if 0
struct cyusb3610_rx_pkt_header {
