...
TRACE_EVENT(tracing_mark_write2,
...
#define SDE_ATRACE_END(name) trace_tracing_mark_write2(current->tgid, name, 0)
#define SDE_ATRACE_BEGIN(name) trace_tracing_mark_write2(current->tgid, name, 1)
