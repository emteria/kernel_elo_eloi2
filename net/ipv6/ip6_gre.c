...
{
/* 2018/05/30, patch for CVE-2017-5897 {*/
	const struct gre_base_hdr *greh;
	const struct ipv6hdr *ipv6h;
	int grehlen = sizeof(*greh);
/* 2018/05/30, patch for CVE-2017-5897 }*/
	struct ip6_tnl *t;
	int key_off = 0;  // 2018/05/30, patch for CVE-2017-5897
	__be16 flags;
	__be32 key;  // 2018/05/30, patch for CVE-2017-5897
...
/* 2018/05/30, patch for CVE-2017-5897 }*/
	...
	if (!pskb_may_pull(skb, offset + grehlen))  // 2018/05/30, patch for CVE-2017-5897
		return;
	ipv6h = (const struct ipv6hdr *)skb->data;
	greh = (const struct gre_base_hdr *)(skb->data + offset);  // 2018/05/30, patch for CVE-2017-5897
	key = key_off ? *(__be32 *)(skb->data + key_off) : 0;  // 2018/05/30, patch for CVE-2017-5897
	t = ip6gre_tunnel_lookup(skb->dev, &ipv6h->daddr, &ipv6h->saddr,
				 key, greh->protocol);  // 2018/05/30, patch for CVE-2017-5897
	if (t == NULL)
		return;
